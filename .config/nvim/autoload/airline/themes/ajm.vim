...
let s:N2 = [ '#CAE682' , '#32322F' , 4, 235 ]  " info
let s:N3 = [ '#CAE682' , '#242424' , 4, 234 ]  " statusline
let s:N4 = [ '#86CD74' , 4 ]         " mode modified

" Insert mode
let s:I1 = [ '#141413' , '#FDE76E' , 232 , 2 ]
let s:I2 = [ '#FDE76E' , '#32322F' , 2 , 235 ]
let s:I3 = [ '#FDE76E' , '#242424' , 2 , 234 ]
let s:I4 = [ '#FADE3E' , 2 ]

" Visual mode
let s:V1 = [ '#141413' , '#B5D3F3' , 232 , 5 ]
let s:V2 = [ '#B5D3F3' , '#32322F' , 5, 235 ]
let s:V3 = [ '#B5D3F3' , '#242424' , 5, 234 ]
let s:V4 = [ '#7CB0E6' , 5 ]

" Replace mode
let s:R1 = [ '#141413' , '#E5786D' , 232 , 9 ]
let s:R2 = [ '#E5786D' , '#32322F' , 9 , 235 ]
let s:R3 = [ '#E5786D' , '#242424' , 9 , 234 ]
let s:R4 = [ '#E55345' , 9 ]
